...
// readYAML decodes a YAML file into v. A missing file leaves v alone and
// reports no error: an empty history and an absent one are the same thing to
// everyone but the filesystem.
//
